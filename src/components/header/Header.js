...
import {getVideosByCategory } from '../action/videoAction';
...
const Header = ({user}) => {
    ...
    const searchHandler = (e) =>{
        e.preventDefault();
        dispatch(getVideosByCategory(input));
            ...
            <div className="header_container">
                ...
                <div className="middlemenu">
                    <div className="searchbar">
                        <form onSubmit={searchHandler}>
                            <input onChange={(e)=>onchangeHandler(e)} type="text" placeholder="Search"></input>
                        </form>
                    </div>
                    <div className="searchbutton" onClick={searchHandler}>
                        <SearchIcon />
                    </div>
                ...
                <div className="right_menu">
                    ...
                    <div className="avatar">
                        { user ? <img src={user.additionalUserInfo.profile.picture} alt="profile_picture"/> :<AccountCircleIcon />}
